                  ...
                  <Card key={index} className="hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-0 bg-white dark:bg-gray-800 overflow-hidden group">
                    ...
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2 group-hover:text-green-600 transition-colors">
                        <div className="p-2 rounded-lg bg-green-50 text-green-600 group-hover:bg-green-600 group-hover:text-white transition-all duration-300">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="pt-4 border-t border-gray-100 mt-auto">
                        ...
                        <Button
                          className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg shadow-green-200"
                          onClick={() => {
                ...
                {setor.contactos.map((contacto, index) => (
                  <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
                    <CardHeader className="pb-4">
                      ...
                      <CardTitle className="text-lg">{contacto.responsavel}</CardTitle>
                    </CardHeader>
