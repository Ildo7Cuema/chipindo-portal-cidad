  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div data-tabs-container>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-8 md:mt-12">
            <TabsList className="flex w-full gap-1 md:gap-2 p-1.5 md:p-2 bg-muted/50 rounded-xl overflow-x-auto scrollbar-hide -mx-4 px-4 md:mx-0 md:px-2">
              <TabsTrigger 
                value="programas" 
                className="flex-shrink-0 md:flex-1 min-h-[44px] text-xs sm:text-sm px-4 md:px-3 py-2.5 rounded-lg transition-all duration-200 active:scale-[0.98]"
              >
                  ...
                  >
                    ...
                    <CardContent className="p-4 md:p-6 pt-0">
                      <div className="space-y-3">
                        {contacto.telefone && (
                          <div className="flex items-center gap-3 min-h-[44px] p-2 -m-2 rounded-xl hover:bg-muted/50 transition-all duration-200">
                        ...
                        {contacto.endereco && (
                          <div className="flex items-start gap-3 min-h-[44px] p-2 -m-2 rounded-xl hover:bg-muted/50 transition-all duration-200">
      ...
      <Dialog open={openDetalhes} onOpenChange={setOpenDetalhes}>
        <DialogContent className="w-full h-full md:h-auto md:max-h-[90vh] max-w-full md:max-w-2xl rounded-none md:rounded-xl p-0 overflow-hidden">
          <div className="flex flex-col h-full max-h-screen md:max-h-[90vh]">
            <DialogHeader className="p-4 md:p-6 pb-0 flex-shrink-0">
              <DialogTitle className="text-lg md:text-xl pr-8">{detalheInfra?.nome}</DialogTitle>
            ...
            <DialogFooter className="p-4 md:p-6 pt-4 border-t flex-shrink-0">
              <Button 
                variant="outline" 
