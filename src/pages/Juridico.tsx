    ...
    useEffect(() => {
        ...
        const loadSetor = async () => {
            try {
                setLoading(true);
                setError(null);
                const data = await getSetorBySlug('juridico');
                if (!isMounted) return;
                if (data) {
            ...
            <div className="min-h-screen bg-background">
                ...
                <div className="flex items-center justify-center min-h-[60vh]">
                    <div className="text-center">
                        ...
                        <p className="text-muted-foreground">O Gabinete Jurídico não está disponível no momento.</p>
                    </div>
                </div>
                <Footer />
            </div>
                        ...
                        <div className="overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0 scrollbar-hide pb-1">
                            <TabsList className="inline-flex sm:flex sm:flex-wrap w-max sm:w-full gap-1.5 sm:gap-2 p-1.5 sm:p-2 bg-muted/60 backdrop-blur-sm rounded-xl shadow-sm">
                                <TabsTrigger value="programas" className="min-h-[48px] sm:min-h-[44px] flex-shrink-0 sm:flex-1 min-w-[110px] sm:min-w-0 text-sm font-medium px-4 py-3 rounded-xl data-[state=active]:shadow-md transition-all touch-manipulation">
                                    <BookOpenIcon className="w-4 h-4 mr-2 sm:hidden" /><span className="truncate">Programas</span>
                                </TabsTrigger>
                                <TabsTrigger value="oportunidades" className="min-h-[48px] sm:min-h-[44px] flex-shrink-0 sm:flex-1 min-w-[130px] sm:min-w-0 text-sm font-medium px-4 py-3 rounded-xl data-[state=active]:shadow-md transition-all touch-manipulation">
                                    <FileTextIcon className="w-4 h-4 mr-2 sm:hidden" /><span className="truncate">Oportunidades</span>
                                </TabsTrigger>
                                <TabsTrigger value="infraestruturas" className="min-h-[48px] sm:min-h-[44px] flex-shrink-0 sm:flex-1 min-w-[145px] sm:min-w-0 text-sm font-medium px-4 py-3 rounded-xl data-[state=active]:shadow-md transition-all touch-manipulation">
                                    <BuildingIcon className="w-4 h-4 mr-2 sm:hidden" /><span className="truncate">Infraestruturas</span>
                                </TabsTrigger>
                        ...
                        <TabsContent value="programas" className="mt-5 sm:mt-8 lg:mt-10 animate-in fade-in-50 duration-300">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
                                {setor.programas.map((programa, index) => (
                                    <Card key={index} className="group relative flex flex-col hover:shadow-2xl hover:shadow-slate-100/50 transition-all duration-300 hover:-translate-y-1 border-0 bg-white dark:bg-gray-800/90 overflow-hidden rounded-xl">
                                        <div className="h-1.5 sm:h-1 bg-gradient-to-r from-slate-600 to-gray-700 w-full" />
                                        <CardHeader className="p-4 sm:p-5 lg:p-6 pb-3 sm:pb-4">
                                            <CardTitle className="flex items-start gap-3 text-base sm:text-lg group-hover:text-slate-700 transition-all duration-200">
                                                <div className="p-2.5 sm:p-3 rounded-xl bg-slate-50 dark:bg-slate-900/30 text-slate-600 dark:text-slate-400 group-hover:bg-slate-700 group-hover:text-white transition-all duration-200 shrink-0">
                                                ...
                                                <ul className="grid gap-2">
                                                    {programa.beneficios?.map((beneficio: string, idx: number) => (
                                                        <li key={idx} className="text-sm text-gray-600 dark:text-gray-300 flex items-start gap-2.5">
                                                            <div className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 shrink-0" /><span>{beneficio}</span>
                                                        </li>
                                                    ))}
                                                </ul>
                                            </div>
                                            <div className="pt-4 border-t border-gray-100 dark:border-gray-700 mt-auto">
                                                <Button className="w-full min-h-[48px] sm:min-h-[44px] bg-gradient-to-r from-slate-700 to-gray-800 hover:from-slate-800 hover:to-gray-900 text-white font-medium rounded-xl transition-all active:scale-[0.98] touch-manipulation"
                                    ...
                                    <Card key={index} className="group relative flex flex-col hover:shadow-2xl hover:shadow-blue-100/50 transition-all duration-300 hover:-translate-y-1 border-0 bg-white dark:bg-gray-800/90 overflow-hidden rounded-xl">
                                        ...
                                        <CardHeader className="p-4 sm:p-5 lg:p-6 pb-3 sm:pb-4">
                                            <div className="flex flex-wrap justify-between items-center gap-2 mb-3">
                                                ...
                                                <Badge variant="outline" className="text-xs border-blue-200 text-blue-600 px-2.5 py-1">
                                        ...
                                        <CardContent className="flex-1 flex flex-col p-4 sm:p-5 lg:p-6 pt-0">
                                            <div className="pt-4 border-t border-gray-100 dark:border-gray-700 mt-auto">
                                                <Button className="w-full min-h-[48px] sm:min-h-[44px] bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-medium rounded-xl transition-all active:scale-[0.98] touch-manipulation"
                                    ...
                                    <Card key={index} className="group relative flex flex-col hover:shadow-2xl hover:shadow-orange-100/50 transition-all duration-300 hover:-translate-y-1 border-0 bg-white dark:bg-gray-800/90 overflow-hidden rounded-xl">
                                        ...
                                        <CardHeader className="p-4 sm:p-5 lg:p-6 pb-3 sm:pb-4">
                                            <div className="flex items-center justify-between mb-3 gap-2">
                                                <div className="p-2.5 sm:p-3 bg-orange-50 dark:bg-orange-900/30 rounded-xl text-orange-600 group-hover:bg-orange-600 group-hover:text-white transition-all shrink-0">
                                                    <BuildingIcon className="w-5 h-5" />
                                                </div>
                                                <Badge variant="outline" className="border-orange-200 text-orange-700 text-xs px-2.5 py-1">Instalação</Badge>
                                            </div>
                                        ...
                                        <CardContent className="flex-1 flex flex-col p-4 sm:p-5 lg:p-6 pt-0">
                                            <div className="pt-4 border-t border-gray-100 dark:border-gray-700 mt-auto">
                                                <Button variant="outline" className="w-full min-h-[48px] sm:min-h-[44px] border-orange-200 text-orange-700 hover:bg-orange-50 font-medium rounded-xl transition-all active:scale-[0.98] touch-manipulation"
                                    ...
                                    <Card key={index} className="group relative overflow-hidden hover:shadow-xl hover:shadow-purple-100/50 transition-all duration-300 hover:-translate-y-0.5 border-0 bg-white dark:bg-gray-800/90 rounded-xl">
                                        ...
                                        <CardContent className="p-4 sm:p-5 lg:p-6 pt-0">
                                            <div className="space-y-1">
                                                {contacto.telefone && (
                                                    <a href={`tel:${contacto.telefone}`} className="flex items-center gap-3 min-h-[48px] sm:min-h-[44px] py-2 px-3 -mx-3 rounded-xl hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all touch-manipulation">
                                                ...
                                                {contacto.email && (
                                                    <a href={`mailto:${contacto.email}`} className="flex items-center gap-3 min-h-[48px] sm:min-h-[44px] py-2 px-3 -mx-3 rounded-xl hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all touch-manipulation">
                ...
                <DialogContent className="w-full max-w-2xl h-[100dvh] sm:h-auto sm:max-h-[85vh] rounded-none sm:rounded-2xl p-0 overflow-hidden border-0 sm:border gap-0">
                    <div className="flex flex-col h-full">
                        ...
                        <DialogHeader className="p-5 sm:p-6 pb-4 border-b border-gray-100 dark:border-gray-800 shrink-0 relative">
                            <button onClick={() => setOpenDetalhes(false)} className="sm:hidden absolute right-4 top-4 p-2 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 transition-all touch-manipulation" aria-label="Fechar">
                                <XIcon className="w-5 h-5 text-gray-500" />
                            </button>
                            <div className="flex items-start gap-3 pr-10 sm:pr-0">
                                <div className="p-2.5 bg-orange-50 dark:bg-orange-900/30 rounded-xl text-orange-600 shrink-0"><BuildingIcon className="w-5 h-5" /></div>
                                <div>
