              ...
              {setor.programas.map((programa, index) => (
                <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
                  <CardHeader className="pb-3 sm:pb-4">
                    <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                      <div className="p-1.5 sm:p-2 bg-red-100 rounded-lg">
                        <HeartHandshakeIcon className="w-4 h-4 sm:w-5 sm:h-5 text-red-600" />
                      </div>
                  ...
                  <CardContent className="space-y-3 sm:space-y-4">
                    <div>
                      <h4 className="font-medium text-xs sm:text-sm mb-2">Benefícios:</h4>
                    ...
                    <div>
                      <h4 className="font-medium text-xs sm:text-sm mb-2">Requisitos:</h4>
                      <ul className="space-y-1">
                        {programa.requisitos?.map((requisito: string, idx: number) => (
                          <li key={idx} className="text-xs sm:text-sm text-muted-foreground flex items-center gap-2">
                            <div className="w-1.5 h-1.5 bg-red-500 rounded-full flex-shrink-0" />
                            <span className="truncate">{requisito}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
