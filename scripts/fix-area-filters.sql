-- Script para corrigir problemas com filtros por área
-- Este script resolve problemas comuns nos filtros de área de interesse

-- 1. Verificar registros sem áreas de interesse
SELECT 
...
-- 4. Corrigir registros sem áreas (definir como 'Programa')
