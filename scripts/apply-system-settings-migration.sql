-- Apply system settings migration
-- This script creates the system_settings and system_stats tables
...
-- Insert some initial stats for testing
INSERT INTO public.system_stats (metric_name, metric_value) VALUES
('backup', '{"timestamp": "2024-01-15T14:30:00Z", "type": "initial"}'),
('cache_clear', '{"timestamp": "2024-01-15T10:00:00Z"}'),
('database_optimization', '{"timestamp": "2024-01-15T09:00:00Z"}')
