...
CREATE TRIGGER update_setores_estrategicos_updated_at BEFORE UPDATE ON setores_estrategicos FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_setores_estatisticas_updated_at BEFORE UPDATE ON setores_estatisticas FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_setores_programas_updated_at BEFORE UPDATE ON setores_programas FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_setores_oportunidades_updated_at BEFORE UPDATE ON setores_oportunidades FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_setores_infraestruturas_updated_at BEFORE UPDATE ON setores_infraestruturas FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_setores_contactos_updated_at BEFORE UPDATE ON setores_contactos FOR EACH ROW EXECUTE FUNCTION update_updated_at_column(); 