-- Migração para adicionar acesso por setor aos perfis de utilizadores
...
COMMENT ON FUNCTION check_sector_access IS 'Verifica se um utilizador tem acesso a um setor específico baseado no seu role';
